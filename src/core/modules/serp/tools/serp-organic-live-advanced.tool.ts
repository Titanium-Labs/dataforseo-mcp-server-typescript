  ...
  getParams(): z.ZodRawShape {
    return {
      ...
      location_name: z.string().default("United States")
        .describe(`full name of the location
required field
...
number of results in SERP`),
      ...
      max_crawl_pages: z.number().min(1).max(7).optional().default(1)
        .describe(`page crawl limit
optional field
        ...
        [
          {
            ...
            people_also_ask_click_depth:
              ...
              params.people_also_ask_click_depth > 0
                ? params.people_also_ask_click_depth
                : undefined,
          },
        ]
